...
`;
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-white flex justify-center items-center">
        <div className="text-[#2C3E50] text-xl">Loading scripts...</div>
      </div>
    );
  }

  if (!results || !results.ideas || !results.scripts) {
    return (
      <div className="min-h-screen bg-white flex justify-center items-center">
        <div className="text-[#2C3E50] text-xl">
          Error: No scripts found. Please <button 
            onClick={() => {
              localStorage.clear();
              router.push('/');
            }}
  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>Your Scripts | Viral Tech Video Script Generator</title>
